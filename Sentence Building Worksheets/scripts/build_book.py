...
BOOK = [
    ...
    ('Y', [('071', 'yacht', 'a'), ('071', 'yacht', 'a')]),
    ('Z', [('003', 'zebra', 'a'), ('003', 'zebra', 'a')]),
]
...
def vectorize(key):
    ...
    src = (os.path.join(MAG, key[2:] + '.png') if key.startswith('M:')
           else os.path.join(TOD, key + '.png'))
...
def terms():
    ...
    ins = ['44 worksheets, two for each letter from A to Z.',
